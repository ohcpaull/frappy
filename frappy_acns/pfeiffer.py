...
class PfeifferTPGPressureSensor(HasIO, Readable):
    ...
    STATUS_MAP = {
        ...
        '0100': (ERROR, 'no hardware'),
        '0010': (ERROR, 'inadmissible parameter'),
        '0001': (ERROR, 'syntax error'),
    }
    ...
    def read_status(self):
        reply = self.communicate(f'ERR')
        self.status = self.STATUS_MAP.get(reply, (ERROR, 'bad status'))
        return self.status
